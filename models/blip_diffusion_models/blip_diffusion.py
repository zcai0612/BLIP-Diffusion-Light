...
from common.utils import download_and_untar, is_url
from models.base_model import BaseModel
from models.blip2_models.blip2_qformer import Blip2Qformer
from models.blip_diffusion_models.modeling_ctx_clip import CtxCLIPTextModel
from models.blip_diffusion_models.utils import numpy_to_pil, prepare_cond_image
from models.blip_diffusion_models.ptp_utils import (
    LocalBlend,
    ...
    def _predict_noise(
        ...
        if hasattr(self, "controlnet"):
            cond_image = prepare_cond_image(
                cond_image, width, height, batch_size=1, dtype=self.dtype, device=self.device
            )
