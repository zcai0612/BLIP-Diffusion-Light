...
from models.blip_models import tie_encoder_decoder_weights
from models.blip_models.blip import BlipBase
from models.blip_models.blip_outputs import (
    BlipOutput,
    BlipSimilarity,
...
class BlipPretrain(BlipBase, SharedQueueMixin, MomentumDistilationMixin):
    ...
    def forward(self, samples):
        ...
        Returns:
            BlipOutput: A BlipOutput object containing loss and intermediate output. See ``models.blip_models.blip_outputs.BlipOutput`` for more details.
